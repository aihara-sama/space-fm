    ...
    <Container sx={{ pb: 5, pt: 12 }} component="footer" maxWidth="xl">
        ...
        >
          <Box>
            ...
            <Typography maxWidth={500} mt={3} color="#F1F0EE">
              Space FM is still in early Beta, so please keep in mind that there
              may be some imperfections as we continue to work on improving it.
            </Typography>
      ...
      >
        ...
        <Box display="flex" gap={3}>
          <MuiLink component={Link} href="/#" underline="none" color="#F1F0EE">
            Privacy Policy
          </MuiLink>
          <MuiLink component={Link} href="/#" underline="none" color="#F1F0EE">
            Terms & Conditions
