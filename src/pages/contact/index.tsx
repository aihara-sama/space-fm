        ...
        >
          <Box flex={1}>
            ...
            <Typography
              ...
              mt={5}
            >
              Space FM envisions a world where music and events are not limited
              by borders, intermediaries, or barriers to access. We see a future
              where artists and fans can connect directly, where the magic of
              live music is brought to you wherever you are, and where the
              blockchain revolutionizes the entire music and events industry.
            </Typography>
            <Box
              component="img"
              sx={{ width: "100%" }}
