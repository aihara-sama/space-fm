...
const LocationPage: NextPage = () => {
  ...
  // ~~~~~ JSX ~~~~~
  return (
    <Box py={5} px={7} sx={{ overflow: "hidden" }}>
      <Box
        sx={{
          background:
        ...
        <Box display="flex" justifyContent="end">
          ...
          >
            ...
            <Typography position="relative" zIndex={1} color="#fff">
              ...
              by harnessing the power of blockchain technology. We aim to create
              a decentralized, transparent, and artist-centric ecosystem that
              reimagines the music and live event industry. We believe in
              removing barriers, cutting out intermediaries, and ensuring that
              artists receive fair compensation for their talent and hard work.
            </Typography>
          </Box>
        </Box>
      </Fade>
